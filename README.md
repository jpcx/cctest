# cctest 0.4.1 | [_API Docs_](http://jpcx.github.io/cctest/cctest_8h.html) | [_CHANGELOG_](https://github.com/jpcx/cctest/blob/0.4.1/CHANGELOG.md)
...
```shell
git clone -b 0.4.1 https://github.com/jpcx/cctest.git
```
```makefile
...
# installs header to      ${DESTDIR}${PREFIX}/include/cctest-0.4.1
# installs cmake files to ${DESTDIR}${PREFIX}/lib/cmake/cctest-0.4.1
...
```shell
git clone -b 0.4.1 https://github.com/jpcx/cctest.git # or git submodule add
```
```cmake
